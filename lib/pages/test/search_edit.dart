...
class MySearchPage extends StatefulWidget {
  ...
  @override
  State<MySearchPage> createState() => _MyAppState();
}

class _MyAppState extends State<MySearchPage> {
        ...
        children: [
          ...
          TypeAheadField(
            ...
            itemBuilder: (context, suggestion) => ListTile(
              ...
              leading: const Icon(Icons.shopping_cart),
              title: Text(suggestion is Map ? suggestion['name'] : ""),
              subtitle: Text('\$${suggestion is Map ? suggestion['price'] : ""}'),
            ),
